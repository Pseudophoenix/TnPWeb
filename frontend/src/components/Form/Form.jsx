    ...
    const fetchProfileData = async () => {
      try {
        ...
        setFormData({
          ...
          otherTenthBoard: profileData.otherTenthBoard || '',
    ...
    <>
      ...
      <div className="form-container">
        ...
        <form className="student-form" onSubmit={handleSubmit}>
          ...
          {formData.tenthBoard === "Other" && (
            <div className="form-group">
              <label htmlFor="otherTenthBoard">Specify Your 10th Board</label>
              <input
                id="otherTenthBoard"
                ...
                onChange={handleChange}
                required={formData.tenthBoard === "Other"}
              />
            </div>
          )}
          <div className="form-group">
          ...
          {formData.twelfthBoard === "Other" && (
            <div className="form-group">
              <label htmlFor="otherTwelfthBoard">Specify Your 12th Board</label>
              <input
                ...
                onChange={handleChange}
                required={formData.twelfthBoard === "Other"}
              />
            </div>
          )}
          <div className="form-group">
          ...
          <div className="form-group">
            <label htmlFor="jeeScore">JEE Percentile</label>
            <input
              id="jeeScore"
              name="jeeScore"
              type="text"
              placeholder="e.g., 97.1/100"
